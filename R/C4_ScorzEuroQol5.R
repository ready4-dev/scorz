...
prototype =  list(a_YouthvarsProfile = youthvars::YouthvarsProfile(),domain_unwtd_var_nms_chr = NA_character_,domain_wtd_var_nms_chr = c("Mobility", "Self-care", "Activities","Pain","Anxiety"),instrument_dict_r3 = make_eq5d_dict(),instrument_nm_1L_chr = 'EuroQol EQ-5D',instrument_version_1L_chr = NA_character_,itm_labels_chr = c("Mobility", "Self-care", "Activities","Pain","Anxiety"),itm_prefix_1L_chr = 'eq5dq_',scrg_dss_ls = list(list()),total_wtd_var_nm_1L_chr = 'eq5d_total_w',total_unwtd_var_nm_1L_chr = 'eq5d_total_c'))
