...
We extract the element of `x` we are interested in - a dataset / data-dictionary pair (an instance of the `Ready4useDyad` class). To make the dataset easier to interpret, we can add labels from the dictionary.
