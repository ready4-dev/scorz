...
## EQ-5D scoring
The [eq5d package](https://github.com/fragla/eq5d) provides a toolkit for scoring EQ-5D health utility. The  `scorz` package contains a class and methods that integrate eq5d package tools and is designed for use with [the ready4 youth mental health systems model](https://www.ready4-dev.com/).
