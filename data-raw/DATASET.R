...
x <- ready4fun::make_pkg_desc_ls(pkg_title_1L_chr = "Score Multi-Attribute Instruments" %>% tools::toTitleCase(),
                                 pkg_desc_1L_chr = "Tools to summarise multiple questionnaire responses in a single index measure (e.g. calculating health utility from multi-attribute utility instrument items) for use in models developed with the ready4 framework (https://www.ready4-dev.com/).
