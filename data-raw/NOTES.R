...
Y <- ingest(X)
abbreviations_lup <- Y@b_Ready4useIngest@objects_ls$abbreviations_lup %>% ready4fun::renew.ready4fun_abbreviations(short_name_chr = c("chu9d"),
                                                                                               long_name_chr = c("CHU-9D"),
                                                                                               plural_lgl = c(F,F))
